            ...
            <div class="card-body">
                <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-4">
                            <label>Model</label>
                            <input type="text" name="p_model" class="form-control rounded-0 @error('p_model') is-invalid @enderror" value="{{ old('p_model') }}">
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <input type="text" name="p_category" class="form-control rounded-0 @error('p_category') is-invalid @enderror" value="{{ old('p_category') }}">
