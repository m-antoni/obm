        ...
        <div class="text-center h-100 project">
          <div class="container">
            <div class="project-text w-100 my-auto text-center text-lg-left">
                  ...
                  <div class="p-2">
                     <a href="{{ route('product.create', $product->id) }}" class="btn btn-primary btn-lg btn-block rounded-0">CASH ON DELIVERY</a>
                  </div>
                  <div class="p-2">
                      <a href="#" class="btn btn-warning btn-lg btn-block rounded-0"> DEPOSIT ON BANK</a>
                  </div>
            </div>
          </div>
        </div>
