    ...
    <div class="card">
        <div class="card-header text-center bg-dark py-3">
           ...
           <span class="splash-description text-white">
              <i class="fa fa-dolly"></i> CHECK OUT COD
           </span>
        ...
        <div class="card-body">
            <form action="{{ route('cod.store') }}" method="POST">
                ...
                <a href="#" class="btn btn-outline-dark btn-block mt-3" data-toggle="modal" data-target="#confirmCOD">
                  <i class="fa fa-send"></i> 
                    Place your order  
                </a>           

                {{-- Confirm Modal --}}
                <div class="modal fade" id="confirmCOD" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
