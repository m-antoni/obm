...
<div class="splash-container">
    <div class="card">
        <div class="card-header text-center bg-dark py-3">
            ...
            </a><span class="splash-description text-white"><i class="fa fa-credit-card"></i>
             Pay Over The Counter</span>
                    ...
                    <div class="list-group">
                        <div class="list-group-item">
                            ...
                            <span class="float-right">
                                <a href="#" class="text-danger" data-toggle="modal" data-target="#addNewBank">
                            ...
                            <div>
                              @if(count($details) > 0)
                                ...
                                data-toggle="modal" data-target="#chooseAnotherBank">
   ...
   {{-- Choose Another Modal --}}
    <div class="modal fade" id="chooseAnotherBank" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
          <div class="modal-content">
              <div class="modal-header">
              ...
              <div class="modal-body">
                  <form action="{{ route('update.details.bank') }}" method="POST" id="chooseAnotherFormBank">
                      @csrf
    ...
    {{-- Add New Modal --}}
    <div class="modal fade" id="addNewBank" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
          <div class="modal-content">
              <div class="modal-header">
              ...
              <div class="modal-body">
                  <form action="{{ route('add.details.bank') }}" method="POST" id="addNewFormBank">
                      @csrf
                      <div class="form-group">
...
@section('script')
  ...
  <script>
    $(document).ready(function(){
         (function(){
          document.querySelector('#addNewFormBank').addEventListener('submit', function(e){
              e.preventDefault();
        ...
        (function(){
          document.querySelector('#chooseAnotherFormBank').addEventListener('submit', function(e){
              e.preventDefault();
